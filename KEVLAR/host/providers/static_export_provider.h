...
MONITOR uint8_t KdDebuggerEnabled = 0;
MONITOR uint8_t KdEnteredDebugger = 0;
...
MONITOR uint8_t KeNumberProcessors = 0;
MONITOR uint64_t KiBugCheckData = 0;
MONITOR uint64_t LpcPortObjectType = 0;
MONITOR uint32_t Mm64BitPhysicalAddress = 0;
MONITOR uint64_t MmBadPointer = 0;
MONITOR uint64_t MmHighestUserAddress = 0;
MONITOR uint64_t MmSectionObjectType = 0;
MONITOR uint64_t MmSystemRangeStart = 0;
MONITOR uint64_t MmUserProbeAddress = 0;
MONITOR uint16_t NlsAnsiCodePage = 0;
MONITOR uint8_t NlsMbCodePageTag = 0;
MONITOR uint8_t NlsMbOemCodePageTag = 0;
MONITOR uint16_t NlsOemCodePage = 0;
MONITOR uint64_t NtBuildGUID = 0;
MONITOR uint64_t NtBuildLab = 0;
MONITOR uint32_t NtBuildNumber = 0;
MONITOR uint32_t NtGlobalFlag = 0;
MONITOR uint64_t POGOBuffer = 0;
MONITOR uint64_t PsInitialSystemProcess = 0;
MONITOR uint64_t PsJobType = 0;
MONITOR PKLDR_DATA_TABLE_ENTRY PsLoadedModuleList = 0;
MONITOR uint64_t PsLoadedModuleResource = 0x600000;
MONITOR uint64_t PsPartitionType = 0;
MONITOR _OBJECT_TYPE* PsProcessType = 0x0;
...
MONITOR uint64_t __security_cookie_val = 0x00002B992DDFA232ULL;
